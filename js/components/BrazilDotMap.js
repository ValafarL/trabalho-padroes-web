...
export default class BrazilDotMap {
  ...
  static REGION_POLYGONS = {
    norte: [
      [0.3077,0.0076],[0.3297,0.0101],[0.3516,0.0127],[0.3736,0.0076],
      [0.3846,0.0380],[0.4176,0.0405],[0.4396,0.0380],[0.4615,0.0456],
      ...
      [0.1978,0.3924],[0.1758,0.3924],[0.1538,0.3924],[0.1319,0.4224],
      [0.0879,0.4177],[0.0769,0.4051],[0.0659,0.3924],[0.0440,0.3924],
      [0.0110,0.3924],[0.0044,0.3671],[0.0110,0.3418],[0.0000,0.2911],
      [0.0110,0.2405],[0.0330,0.1899],[0.0769,0.1899],[0.0879,0.1772],
      [0.0989,0.1646],[0.0989,0.1266],[0.1319,0.1139],[0.1429,0.0886],
      [0.1538,0.0759],[0.1648,0.1013],[0.1868,0.1139],[0.2198,0.1013],
      [0.2418,0.0886],[0.2637,0.0759],[0.2747,0.0633],[0.2857,0.0380],
      [0.2967,0.0127],
    ],
    ...
    sudeste: [
      ...
      [0.6074,0.5284],[0.7293,0.5590],[0.7033,0.5949],[0.7473,0.6203],
    ],

    sul: [
      [0.5760,0.8101],[0.5582,0.8481],[0.5495,0.8734],[0.5385,0.8861],
      [0.5275,0.8987],[0.5055,0.9241],[0.4945,0.9494],[0.4725,0.9747],
      [0.4505,0.9873],[0.4440,0.9924],[0.4286,0.9873],[0.4066,0.9747],
      [0.3736,0.9494],[0.3516,0.9241],[0.3407,0.8861],[0.3516,0.8481],
      [0.3626,0.8228],[0.3736,0.7975],[0.3846,0.7722],[0.4066,0.7468],
      [0.4176,0.7342],[0.4286,0.7089],[0.4725,0.7009],[0.4835,0.7089],
      [0.5055,0.7468],[0.5275,0.7975],[0.5560,0.8101],
    ],
  };
  ...
  _updateTransitions(dt) {
    ...
    for (const key of Object.keys(BrazilDotMap.REGIONS)) {
      ...
      this.transitionProgress[key] = Math.min(1, Math.max(0,
  ...
  _drawDot(ctx, dot, t) {
    ...
    const a = 0.50 + t * 0.50;
    const radius = this.dotRadius * (1 + t * 0.50);
